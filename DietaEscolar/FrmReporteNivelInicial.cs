...
{
    public partial class FrmReporteNivelInicial : Form
    {
        public FrmReporteNivelInicial()
        {
            InitializeComponent();
        }

        private void FrmReporteNivelInicial_Load(object sender, EventArgs e)
        {
            ...
            string consulta = "SELECT `nombre`, `dia_semana`, `nro_dias`, `nivel`, `estado`, `fecha` FROM `vista_planeacion` WHERE `nivel` LIKE 'INICIAL Y PRIMARIA' ORDER BY FIELD (`dia_semana`, 'LUNES', 'MARTES', 'MIERCOLES', 'JUEVES', 'VIERNES')";
